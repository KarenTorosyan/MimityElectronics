    ...
    <div class="row">
        ...
        <div  class="col" id="main-sidebar">
          <div class="list-group list-group-flush">
            <a href="home" class="list-group-item list-group-item-action active"><i class="fa fa-home fa-lg fa-fw"></i> Home</a>
  ...
  <header class="navbar navbar-expand navbar-light fixed-top">
    ...
    <div class="dropdown dropdown-user">
      <a class="dropdown-toggle" href="#" role="button" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <img src="/getUserFiles?pictureName=${user.picture}" width="35"/>
        <%}else{%>
          <img src="../img/user.svg" alt="User">
        <%}%>
        <%}%>
  ...
  <div class="col" id="main-content">
    ...
    <div class="swiper-container" id="home-slider">
      <div class="swiper-wrapper">
        <a href="grid.jsp" class="swiper-slide" data-cover="../img/slider/1.jpg" data-xs-height="150px" data-sm-height="265px" data-md-height="300px" data-lg-height="300px" data-xl-height="300px"></a>
        <a href="grid.jsp" class="swiper-slide" data-cover="../img/slider/2.jpg" data-xs-height="150px" data-sm-height="265px" data-md-height="300px" data-lg-height="300px" data-xl-height="300px"></a>
        <a href="grid.jsp" class="swiper-slide" data-cover="../img/slider/3.jpg" data-xs-height="150px" data-sm-height="265px" data-md-height="300px" data-lg-height="300px" data-xl-height="300px"></a>
      </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="row no-gutters gutters-1">
              <div class="col-6 col-md-3 mb-1">
                <a href="grid.jsp" class="card">
                  <img src="../img/categories/1.jpeg" alt="" class="card-img-top">
              ...
              <div class="col-6 col-md-3 mb-1">
                <a href="grid.jsp" class="card">
                  <img src="../img/categories/2.jpeg" alt="" class="card-img-top">
              ...
              <div class="col-6 col-md-3 mb-1">
                <a href="grid.jsp" class="card">
                  <img src="../img/categories/3.jpeg" alt="" class="card-img-top">
              ...
              <div class="col-6 col-md-3 mb-1">
                <a href="grid.jsp" class="card">
                  <img src="../img/categories/4.jpeg" alt="" class="card-img-top">
          ...
          <div class="swiper-slide">
            <div class="row no-gutters gutters-1">
              <div class="col-6 col-md-3 mb-1">
                <a href="grid.jsp" class="card">
                  <img src="../img/categories/5.jpeg" alt="" class="card-img-top">
              ...
              <div class="col-6 col-md-3 mb-1">
                <a href="grid.jsp" class="card">
                  <img src="../img/categories/6.jpeg" alt="" class="card-img-top">
              ...
              <div class="col-6 col-md-3 mb-1">
                <a href="grid.jsp" class="card">
                  <img src="../img/categories/8.jpeg" alt="" class="card-img-top">
              ...
              <div class="col-6 col-md-3 mb-1">
                <a href="categories.jsp" class="card">
    ...
    <div class="row no-gutters gutters-2">
      ...
      <div class="col-6 col-md-3 mb-2">
        <div class="card card-product">
          <button class="wishlist" title="Add to wishlist"><i class="fa fa-heart"></i></button>
          <a href="detail.jsp"><img src="../img/product/3.jpg" alt="SanDisk Cruzer CZ36 64GB USB 2.0 Flash Drive" class="card-img-top"></a>
          <div class="card-body">
            <span class="price">$13.49</span>
            <a href="detail.jsp" class="card-title h6">SanDisk Cruzer CZ36 64GB USB 2.0 Flash Drive</a>
            <div class="d-flex justify-content-between align-items-center">
      ...
      <div class="col-6 col-md-3 mb-2">
        <div class="card card-product">
          <button class="wishlist active" title="Added to wishlist"><i class="fa fa-heart"></i></button>
          <a href="detail.jsp"><img src="../img/product/4.jpg" alt="Sony Alpha a6500 Mirrorless Digital Camera" class="card-img-top"></a>
          <div class="card-body">
            <span class="price">$1,098.00</span>
            <a href="detail.jsp" class="card-title h6">Sony Alpha a6500 Mirrorless Digital Camera</a>
            <div class="d-flex justify-content-between align-items-center">
              <button type="button" class="btn btn-outline-info btn-sm btn-block">Add to cart</button>
            </div>
          </div>
