...
<html lang="en">
  <head>
    ...
    <title>Shop Detail - Mimity</title>
  </head>
  <body>
      ...
      <div class="row">
        ...
        <div class="col" id="main-sidebar">
          <div class="list-group list-group-flush">
            ...
            <a href="grid.jsp" class="list-group-item list-group-item-action sub active">Computers</a>
        ...
        <div class="col" id="main-content">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="grid.jsp" class="text-info">Computers &amp; Accessories</a></li>
