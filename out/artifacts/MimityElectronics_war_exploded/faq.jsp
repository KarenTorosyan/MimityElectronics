      ...
      <div class="row">
        ...
        <div class="col" id="main-sidebar">
          <div class="list-group list-group-flush">
            ...
            <a href="faq.jsp" class="list-group-item list-group-item-action sub active">FAQ</a>
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="alert alert-info" role="alert">
                Was this article helpful ? <a href="#" class="alert-link">Yes</a> / <a href="contact.jsp" class="alert-link">No, I want to contact support</a>
              </div>
            </div>
          </div>
