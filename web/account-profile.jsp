        ...
        <div class="col" id="main-sidebar">
          <div class="list-group list-group-flush">
            ...
            <div class="collapse show" id="pages">
              ...
              <a href="account-profile.jsp" class="list-group-item list-group-item-action sub active">My Profile</a>
          ...
          <div class="card user-card">
            <div class="card-body">
              ...
              <ul class="nav nav-pills">
                <li class="nav-item">
                  <a class="nav-link active" href="account-profile.jsp">Profile</a>
                </li>
                <li class="nav-item">
