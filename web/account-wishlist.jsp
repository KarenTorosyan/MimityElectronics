        ...
        <div class="col" id="main-sidebar">
          <div class="list-group list-group-flush">
            ...
            <div class="collapse show" id="pages">
              ...
              <a href="account-wishlist.jsp" class="list-group-item list-group-item-action sub active">My Wishlist</a>
            </div>
          ...
          <div class="card user-card">
            <div class="card-body">
              ...
              <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="account-address.jsp">Address</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" href="account-wishlist.jsp">Wishlist</a>
                </li>
              </ul>
              <hr>
              <table class="table table-cart">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="detail.jsp"><img src="../img/product/2.jpg" width="50" height="50" alt="Apple 15.4&quot; MacBook Pro Laptop Space Gray"></a>
                      <button class="btn btn-sm btn-outline-warning rounded">Remove</button>
                    </td>
                    <td>
                      <h6><a href="detail.jsp" class="text-body">Apple 15.4&quot; MacBook Pro Laptop Space Gray</a></h6>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="detail.jsp"><img src="../img/product/4.jpg" width="50" height="50" alt="Sony Alpha a6500 Mirrorless Digital Camera"></a>
                      <button class="btn btn-sm btn-outline-warning rounded">Remove</button>
                    </td>
                    <td>
                      <h6><a href="detail.jsp" class="text-body">Sony Alpha a6500 Mirrorless Digital Camera</a></h6>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="detail.jsp"><img src="../img/product/6.jpg" width="50" height="50" alt="Xbox One X 1TB Console - PUBG Bundle"></a>
                      <button class="btn btn-sm btn-outline-warning rounded">Remove</button>
                    </td>
                    <td>
                      <h6><a href="detail.jsp" class="text-body">Xbox One X 1TB Console - PUBG Bundle</a></h6>
