...
<html lang="en">
  <head>
    ...
    <title>Product Comparison - Mimity</title>
  </head>
  <body>
      ...
      <div class="row">
        ...
        <div class="col" id="main-sidebar">
          <div class="list-group list-group-flush">
            ...
            <a href="compare.jsp" class="list-group-item list-group-item-action sub active">Compare</a>
            ...
            <table class="table table-bordered text-center table-wishlist">
              <thead>
                <tr>
                  ...
                  <th>
                    <p><a href="detail.jsp"><img src="../img/product/2.jpg" width="75" height="75" alt="Apple 15.4&quot; MacBook Pro Laptop Space Gray"></a></p>
                    <p><a href="detail.jsp" class="text-body">Apple 15.4&quot; MacBook Pro Laptop Space Gray</a></p>
                  ...
                  <th>
                    <p><a href="detail.jsp"><img src="../img/product/4.jpg" width="75" height="75" alt="Sony Alpha a6500 Mirrorless Digital Camera"></a></p>
                    <p><a href="detail.jsp" class="text-body">Sony Alpha a6500 Mirrorless Digital Camera</a></p>
                    <div class="btn-group btn-group-sm" role="group">
                      <button type="button" class="btn btn-outline-info"><i class="fa fa-close"></i></button>
                      <button type="button" class="btn btn-outline-info">Add to cart</button>
                    </div>
                  ...
                  <th>
                    <p><a href="detail.jsp"><img src="../img/product/6.jpg" width="75" height="75" alt="Xbox One X 1TB Console - PUBG Bundle"></a></p>
                    <p><a href="detail.jsp" class="text-body">Xbox One X 1TB Console - PUBG Bundle</a></p>
                    <div class="btn-group btn-group-sm" role="group">
                      <button type="button" class="btn btn-outline-info"><i class="fa fa-close"></i></button>
                      <button type="button" class="btn btn-outline-info">Add to cart</button>
                    </div>
