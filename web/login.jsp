...
<html lang="en">
  <head>
    ...
    <title>Login / Register - Mimity</title>
  </head>
  <body>
    ...
    <header class="navbar navbar-expand navbar-light fixed-top">
      ...
      <div class="dropdown dropdown-user">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          ...
          <a class="dropdown-item has-icon" href="/logout"><i class="fa fa-sign-out fa-fw"></i> Sign out</a>
        </div>
      </div>
      <!-- /User Dropdown -->
      ...
      <div class="row">
        ...
        <div class="col" id="main-sidebar">
          <div class="list-group list-group-flush">
            ...
            <a href="login.jsp" class="list-group-item list-group-item-action sub active">Login / Register</a>
                      ...
                      <form action="registration" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                          ...
                          <div class="form-group col-sm-6">
                            ...
                            <input type="number" name="numberPhone" class="form-control" id="registerPhone">
                          </div>
                          <div class="form-group col-sm-6">
                            <label>Your Photo (Not necessary)</label>
